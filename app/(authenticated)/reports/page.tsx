...
const ALL_REPORT_TYPES = ['deposit', 'working-days', 'working-days-by-client', 'settlement', 'branch-performance'] as const
...
export default async function ReportsPage() {
  ...
  return (
    <div className="py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <h1 className="text-xl font-semibold text-slate-900 mb-6">Reports</h1>
        <ReportRunner allowedReports={allowedReports as ('deposit' | 'working-days' | 'working-days-by-client' | 'settlement' | 'branch-performance')[]} />
      </div>
    </div>
  )
}
