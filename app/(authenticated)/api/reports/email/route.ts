  ...
  try {
    ...
    const { error: sendError } = await resend.emails.send({
      ...
      html: reportType === 'working-days-by-client'
        ...
        : `<p>Please find attached the ${reportType === 'deposit' ? 'Deposit Report' : 'Contractor - Working Day Count Report'} for <strong>${hrCode} — ${contractorName}</strong>.</p><p>Generated by ${profile?.display_id ?? 'GS Apps'} on ${new Date().toLocaleDateString('en-GB')}.</p>`,
      attachments: [
        {
          filename,
